...
| M4a | Foundation: country codes + all-country coverage | ⬜ | M2 (intent) | all-country coverage + single $-scale point, integrity check |
...
| M5 | Frontend finalization | ⬜ | M1 (data features after M4b) | clean build + screenshots + `build-ui.command` |
